...
if __name__=='__main__':
    ...
    # python demo.py --task FaceEnhancement --model GPEN-BFR-2048 --out_size 2048 --in_size 512 --use_sr --tile_size 400 --save_face --indir "D:\Users\RPS dev\Desktop\faceswapp_results\inswapper_pc" --outdir examples/outs-selfie
